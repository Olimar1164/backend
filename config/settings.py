...
CORS_ALLOWED_METHODS = os.getenv('CORS_ALLOWED_METHODS').split(',')
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # URL de tu frontend de Next.js
]
...
# Configurar Django REST Framework para usar JWT
REST_FRAMEWORK = {
